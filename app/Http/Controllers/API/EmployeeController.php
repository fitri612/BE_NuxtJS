    ...
    public function create(CreateEmployeeRequest $request)
    {
        try {
            ...
            $createEmployee = ([
                ...
                'age' => $request->age,
                'phone' => $request->phone,
                'photo' => isset($file) ? $file : null, // if file exists, set file, else set null (default)
                'team_id' => $request->team_id,
                'role_id' => $request->role_id,
            ]);

            $employee = Employee::create($createEmployee);

            // return response
            if (!$employee) {
                throw new Exception('Error in creating employee');
            }
    ...
    public function update(UpdateEmployeeRequest $request, $id)
    {
        try {
            ...
            $employee->update([
                ...
                'age' => $request->age,
                'phone' => $request->phone,
                'photo' => isset($file) ? $file : $employee->photo, // if file exists, set file, else set old file
                'team_id' => $request->team_id,
                'role_id' => $request->role_id,
            ]);
